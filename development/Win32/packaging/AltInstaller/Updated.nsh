Function UpdateModifiedFiles
 ...
 File "${PRODUCT_SOURCEDIR}\Resources\examples\addressExample.adr"
 File "${PRODUCT_SOURCEDIR}\Resources\examples\serial_letter1.lyx"
 File "${PRODUCT_SOURCEDIR}\Resources\examples\serial_letter2.lyx"
 File "${PRODUCT_SOURCEDIR}\Resources\examples\serial_letter3.lyx"
 SetOutPath "$INSTDIR\Resources\examples\de"
 File "${PRODUCT_SOURCEDIR}\Resources\examples\de\serienbrief1.lyx"
 File "${PRODUCT_SOURCEDIR}\Resources\examples\de\serienbrief2.lyx"
 File "${PRODUCT_SOURCEDIR}\Resources\examples\de\serienbrief3.lyx"
