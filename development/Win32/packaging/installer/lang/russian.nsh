...
#${LangFileString} TEXT_CONFIGURE_MIKTEXFNDB "Обновление базы данных файлов MiKTeX..."
...
${LangFileString} TEXT_FINISH_WEBSITE "Перейти на lyx.org за последними новостями, поддержкой и советами"
...
${LangFileString} SecDesktopTitle "Значок рабочего стола"
...
${LangFileString} SecDesktopDescription "Значок LyX на рабочм столе."
...
${LangFileString} EnterLaTeXHeader2 'Задайте дистрибутив LaTeX, который будет использовать LyX.'
${LangFileString} EnterLaTeXFolder 'При необходимости здесь можно задать путь к файлу $\"latex.exe$\" и так задать \
...
${LangFileString} EnterLaTeXFolderNone 'Задайте ниже путь к файлу $\"latex.exe$\". При этом вы зададите, какой \
...
${LangFileString} MiKTeXInfo 'Дистрибутив LaTeX $\"MiKTeX$\" будет использоваться совместно с LyX.$\r$\n\
				...
				Проверить сейчас наличие обновлений MiKTeX?'
...
${LangFileString} MultipleIndexesNotAvailable "Поддержка использования нескольких индексов в документе будет недоступна, поскольку$\r$\n\
						MiKTeX был установлен с правами администратора, а вы устанавливаете LyX без них."
...
${LangFileString} SecUnMiKTeXDescription "Удалить дистрибутив LaTeX MiKTeX."
