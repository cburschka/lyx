...
${LangFileString} SecFileAssocDescription "ÇäåäáÇÊ ĞÇÊ ÇäÇåÊÏÇÏ .lyx ÓêÊå áÊÍçÇ ÊäâÇÆêÇë ÈÈÑæÇåÌ äêã."
...
${LangFileString} EnterLaTeXFolder 'êåãæã çæÇ ÇÎÊêÇÑ ÇäåÓÇÑ ääåäá  $\"latex.exe$\" èÍÏÏ äĞäã  \
					ÊèÒêÙÉ-äÊêã ÇäĞê êÌÈ ÇÓÊÎÏÇåç áê äêã.$\r$\n\
					ÇĞÇ ãæÊ äÇ ÊÓÊÎÏå äÊêã áÇæ äêã äÇ êÓÊ×êÙ ÇÎÑÇÌ ÇäåÓÊæÏÇÊ!$\r$\n\
					$\r$\n\
					Êå ÇäÙËèÑ Ùäé ÊèÒêÙÉ-äÊêã \
					$\"$LaTeXName$\" áê æØÇåã èÊÌÏ åÓÇÑç áê ÇäÇÓáä.'
${LangFileString} EnterLaTeXFolderNone 'áêåÇ äê åÓÇÑ Çäåäá  $\"latex.exe$\". èÍÏÏ äĞäã \
					ÊèÒêÙÉ-äÊêã ÇäĞê êÌÈ ÇÓÊÎÏÇåç áê äêã.$\r$\n\
					ÇĞÇ ãæÊ äÇ ÊÓÊÎÏå äÊêã áÅæ äêã äÇ êÓÊ×êÙ ÇÎÑÇÌ ÇäåÓÊæÏÇÊ!$\r$\n\
					$\r$\n\
...
${LangFileString} StillInstalled "Êå ${APP_SERIES_KEY2} ÈÇäáÙä ÊÑãêÈ ÈÑæÇåÌ äêã äĞÇ Ùäêã ÇèäÇë ÇäÚÇÁ ÊÑãêÈ ÇäæÓÎÉÇäÓÇÈâÉ."
...
${LangFileString} FinishPageMessage "ÊçÇæêæÇ! Êå ÊÑãêÈ äêã ÈæÌÇÍ.$\r$\n\
					$\r$\n\
					(ÊÔÚêä äêã äÃèä åÑÉ âÏ êÃÎĞ ÙÏÉ ËèÇæê.)"
${LangFileString} FinishPageRun "ÊÔÚêä äêã"

${LangFileString} UnNotInRegistryLabel "äå êÊå ÇäÙËèÑ Ùäé äêã áê ÇäÑêÌÓÊÑê.$\r$\n\
					äå êÊå ÍĞá ÇÎÊÕÇÑÇÊ äêã åæ Ó×Í ÇäåãÊÈ èâÇÆåÉ ÇäÈÑÇåÌ."
${LangFileString} UnInstallRunning "êÌÈ ÇÚäÇâ äêã ÇèäÇë!"
${LangFileString} UnNotAdminLabel "êÌÈ Ãæ Êåäã ÕäÇÍêÇÊ ÇäåÏêÑ ääÈÏÁ ÈÙåäêÉ ÇäÍĞá!"
${LangFileString} UnReallyRemoveLabel "çä ÊÑÚÈ ÈÍĞá ÈÑæÇåÌ äêã ÈÇäãÇåä åÙ ãä ÇäãåÈèææÊ ÇäÎÇÕ Èç¿"
...
${LangFileString} SecUnPreferencesDescription 'ÍĞá åÌäÏ ÊÔãêä äêã$\r$\n\
